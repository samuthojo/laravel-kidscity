...
function addProduct() {
  ...
  $.ajax({
         type: "post",
         url: "/admin/categories/" + category_id + "/store_product",
         data: formData,
         contentType: false,
         processData: false,
...
function showEditProductModal(product, category) {
...
function attemptEditProduct() {
  ...
  $.ajax({
    type: "post",
    url: "/admin/categories/" + category_id + "/update_product/" + product_id,
    data: formData,
    contentType: false,
    processData: false,
    success: function(table) {
