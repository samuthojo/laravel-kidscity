...
function addProduct() {
  ...
  $.ajax({
         type: "post",
         url: "/admin/price_categories/" + price_category_id + "/store_product",
         data: formData,
         contentType: false,
         processData: false,
...
function showEditProductModal(product, priceCategory) {
...
function attemptEditProduct() {
  ...
  $.ajax({
    type: "post",
    url: "/admin/price_categories/" + price_category_id + "/update_product/" + product_id,
    data: formData,
    contentType: false,
    processData: false,
    success: function(table) {
...
function showProductDeleteModal(prod, priceCategory) {
...
function deleteProduct() {
  $.ajax({
    type: 'delete',
    url: '/admin/price_categories/' + price_category_id + "/delete_product/" + product_id,
    success: function(table) {
      $(".my_loader").fadeOut(0);
      $(".btn-success").prop("disabled", false);
