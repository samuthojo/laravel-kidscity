...
@section('more')
@include('cms.header')
<script src="{{asset('js/cms_sub_category_products.js')}}"></script>
...
@section('content')
@include('cms.modals.add_sub_category_product_modal')
@include('cms.modals.edit_sub_category_product_modal')
    ...
    <h3 style="font-weight: bold; color: #337ab7;"class="panel-title pull-left">
     ...
     <div class="btn-group pull-right">
       ...
       <button class="btn btn-primary"
         ...
         onclick="showAddModal({{$subCategory->id}})">
              ...
              <td>
                <div class="btn-group">
                  ...
                  <button class="btn btn-warning" title="edit product"
                    onclick="showEditProductModal({{$product}}, {{$subCategory}})">
                    <span class="glyphicon glyphicon-pencil"></span>
                  </button>
                  <button class="btn btn-danger" title="delete product"
                    onclick="showProductDeleteModal({{$product}}, {{$subCategory}})">
